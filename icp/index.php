...
<meta name="description" content="神族九帝api,随机壁纸api,动漫壁纸api,美女壁纸api,一言api,随机头像api,加群api,动漫头像api,手机壁纸api,电脑壁纸api,自动换壁纸api,代刷网api,icp备案查询api">
<meta name="keywords" content="神族九帝api,随机壁纸api,动漫壁纸api,美女壁纸api,一言api,随机头像api,加群api,动漫头像api,手机壁纸api,电脑壁纸api,自动换壁纸api,代刷网api,icp备案查询api">
...
<div style="box-shadow: 5px 5px 25px 0 rgba(46,61,73,.2);border-radius:15px;font-size:13px;width:950px;font-family:微软雅黑,'Helvetica Neue',Arial,sans-serif;margin:10px auto 0px;border:0px solid #eee;max-width:100%;">
    ...
    <div style="margin:0px auto;width:90%">
		...
		<hr>
		# 请求地址 #<br/>
		<a style="color:#fd4b5c;text-decoration:none;">http://api.shenzjd.com/icp/api.php</a><br/>
		# 参数 #<br/>
       ...
       <&#63php <br/>
$dm = $_GET['dm'];<br/>
$str = file_get_contents('http://api.shenzjd.com/icp/api.php?dm='.$dm);<br/>
...
&#60!--HTML代码结束-->
		...
		<hr>
		# 示例 #<br/>
		<a style="color:#fd4b5c;text-decoration:none；" target="_blank">http://api.shenzjd.com/icp/api.php?dm=qq.com</a>
		</h3>
          </div>
</div>
</html>